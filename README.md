...
```
git subtree add --prefix vagrant https://github.com/volcomism/wasted.git master --squash
...
```
git subtree pull --prefix vagrant https://github.com/volcomism/wasted.git master --squash
```
